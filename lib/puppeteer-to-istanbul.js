...
class PuppeteerToIstanbul {
  ...
  writeIstanbulFormat (options) {
    console.log('PuppeteerToIstanbul writeInstabulFormat options');
    console.log(options);
    ...
    var path_temp_str = (options && options.hasOwnProperty('output_dir')) ? options.output_dir : './.nyc_output/js',
        output_obj = _utils.genPath(path_temp_str),
        output_dir_str = output_obj['dir'],
        output_path_str = output_obj['path']
        ;

    console.log('writeInstanbulFormat output_dir_str');
    console.log(output_dir_str);

    console.log('writeInstanbulFormat output_path_str');
    console.log(output_path_str);
